...
Model outputs and checkpoints are stored in Google Drive so that experiments can be recovered after a Colab runtime disconnect.
...
Cached representations allow later stages to continue without re-running the Video Swin and AST feature-extraction stages.
